...
class TokenType:
    ...
    PLUS = "PLUS"
    MINUS = "MINUS"
    MUL = "MUL"          # Додавання множення
    DIV = "DIV"          # Додавання ділення
    LPAREN = "LPAREN"    # Додавання відкривальної дужки
    RPAREN = "RPAREN"    # Додавання закривальної дужки
...
class Lexer:
    ...
    def get_next_token(self):
        ...
        while self.current_char is not None:
            ...
            raise LexicalError("Помилка лексичного аналізу: невідомий символ '{}'".format(self.current_char))
